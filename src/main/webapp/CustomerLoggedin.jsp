...
<title>Mortgage Finance System</title>
</head>
...
%> </h2>
        ...
        <p><a href="http://localhost:8080/official/feedback.jsp">FeedBack Form   </a></p>
        
        <p><a href="http://localhost:8080/official/calculator.jsp">EMI Calculator</a></p>
        
        <p><a href="http://localhost:8080/official/payment.jsp">Make Payment </a></p>
        
        <p><a href="CustomerLogout">Log Out </a></p>
