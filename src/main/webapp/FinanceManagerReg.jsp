...
<title>Finance Manager Sign Up</title>
...
<input type = "hidden" id="status" value="<%= request.getAttribute("status")%>">
	...
	<div class="main">
		...
		<section class="signup">
			<div class="container">
			<h1 align="center" style="margin-top:40px">Finance Manager</h1>
				<div class="signup-content">
					<div class="signup-form">
						<h2 class="form-title">Sign up</h2>
					
						<form method="post" action="FinanceManagerRegister" class="register-form"
							id="register-form">
						...
						<!--  <div class="form-group">
								<label for="dob"><i
									class="zmdi zmdi-account material-icons-name"></i></label> <input
									type="date" name="dob" id="dob" placeholder="DOB" required="required"/>
							</div>-->	
							<div class="form-group">
								<label for="gender"><i
					...
					<div class="signup-image">
						...
						<a href="FinanceManagerLogin.jsp" class="signup-image-link">I am already
							member</a>
