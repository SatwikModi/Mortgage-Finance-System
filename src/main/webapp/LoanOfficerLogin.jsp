...
<title>Loan Officer Sign in</title>
			...
			<h1 align="center">Loan Officer</h1>
				<div class="signin-content">
					<div class="signin-image">
						...
						<a href="LoanOfficerReg.jsp" class="signup-image-link">Create an
							account</a>
					...
					<div class="signin-form">
						...
						<form method="post" action="LoanOfficerLogin" class="register-form"
							id="login-form">
