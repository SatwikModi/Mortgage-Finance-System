			...
			<div class="container">
				<div class="signin-content">
					...
					<div class="signin-image">
						<figure>
							<img src="images/signup.jpg" alt="paste image here" >
						</figure>
						
						<a href="CustomerRegistration.jsp" class="signup-image-link">Create an
							account</a>
					...
					<div class="signin-form">
						...
						<form method="post" action="login" class="register-form"
							...
							<a href="http://localhost:8080/official/forgotPassword.jsp">Forgot Password?</a>
						</form>
